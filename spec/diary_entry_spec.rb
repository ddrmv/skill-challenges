...
RSpec.describe DiaryEntry do
  ...
  describe "#count_words" do
    it "counts correctly 1000 words of contents" do
  ...
  describe "#reading_time" do
    it "raises error if reading speed is 0 or less" do
